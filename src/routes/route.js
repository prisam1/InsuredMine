...
const {Createuser,UserUpdate,UserGet,deleteUser} = require("../controller/UserController")
const {CreateAccount,AccountUpdate,AccountGet,deleteAccount} = require("../controller/AccountController")
const {CreatePolicy,PolicyUpdate,PolicyGet,deletePolicy} = require("../controller/PolicyController")
const {insertarDatosDB} = require("../controller/upload")
...
router.post('/up',upload.single('file'), insertarDatosDB)
